...
class App extends Component {
  ...
  update() {
    ...
    axios.put('/api/update', json).then( res=> this.setState({ status: `status: ${res.status} ${res.statusText}` }))
  }
  delete () {
    this.setState({ status: '...' })
    axios.delete('/api/delete').then( res=> this.setState({ status: `status: ${res.status} ${res.statusText}` }))
  }
